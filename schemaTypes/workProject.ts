...
export const workProject = defineType({
  ...
  fields: [
    defineField({
      ...
      type: "string",
      description:
        'The name of the project (e.g., "Sweaty Boy", "A Better Tomorrow")',
    ...
    defineField({
      ...
      type: "array",
      description:
        "The video(s) displayed on the project detail page. Add one or more.",
      of: [
        {
          type: "object",
          name: "video",
    ...
    defineField({
      ...
      type: "number",
      description:
        "Controls the position on the Work listing page. Lower numbers appear first.",
